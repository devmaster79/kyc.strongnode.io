...
module.exports = (app: Express) => {
  ...
  router.post(
    '/enablePasswordAuth',
    auth(MODE_FULL),
    authController.enablePasswordAuth
  )
  router.post(
    '/disablePasswordAuth',
    auth(MODE_FULL),
    authController.disablePasswordAuth
  )
  router.post(
    '/authByPassword',
    auth(MODE_2FA),
  ...
  router.post('/disableSMSAuth', auth(MODE_FULL), authController.disableSMSAuth)
  ...
  router.post(
    ...
    auth(MODE_FULL),
    authController.generateAuthenticatorQRCode
  )
  router.post(
    '/enableAuthenticatorAuth',
    auth(MODE_FULL),
    authController.enableAuthenticatorAuth
  )
  router.post(
    '/disableAuthenticatorAuth',
    auth(MODE_FULL),
    authController.disableAuthenticatorAuth
  )
