...
export function Register() {
  ...
  const { data: sendResult, call: registration } = useService(authService.register);
    ...
    <>
      ...
      <HelpText>
        ...
        {sendResult.result === 'limit-reached-error' && (
          <ErrorMessage>
            Sorry, but the maximum number of users limit is reached. We cannot allow new
            registrations.
          </ErrorMessage>
        )}
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Note>
          After completing the registration, we will subscribe you to our mailing list. We will only
          send you emails to let you know when <b>Early Access</b> is available for StrongNode Edge
          products
        </Note>
