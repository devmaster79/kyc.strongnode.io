...
const GenerateQRCodeMessage = (props: MessageProps<typeof generateAuthenticatorQRCode>) => {
  if (props.data.result === 'loading') return <></>
  if (props.data.result === 'success') return <></>
  return <DashboardForm.ErrorMessage>Something went wrong. Please try again later.</DashboardForm.ErrorMessage>
}

const EnableAuthenticatorAuthMessage = (props: MessageProps<typeof enableAuthenticatorAuth>) => {
  ...
  return (
    <DashboardForm.ErrorMessage>We could not verify your password. Please try again later.</DashboardForm.ErrorMessage>
  )
}
