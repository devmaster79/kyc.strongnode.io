    ...
    <Modal
      ...
      footer={(
        <>
          ...
          <Button type='button' variant='medium' onClick={() => verifySMSCode()}>Confirm</Button>
        </>
      )}
    >
      <ModalForm>
...
const Messages = (props: { authService: ServicesProps<typeof authServices> }) => {
  ...
  return (
    <DashboardForm.InfoMessage>Fill in your phone number and we will send you a password.</DashboardForm.InfoMessage>
  )
}
