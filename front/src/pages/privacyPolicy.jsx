    ...
    <>
      <Box>
        <div className='col-md-12'>
          <h1>Privacy Policy for Strongnode</h1>
          <p>At https://id.strongnode.io, accessible from https://id.strongnode.io, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by https://id.strongnode.io and how we use it.
          </p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in https://id.strongnode.io. This policy is not
            applicable to any information collected offline or via channels other than this website. Our Privacy Policy
            was created with the help of the <a href='https://www.generateprivacypolicy.com/'>Free Privacy Policy
              Generator
            </a>.
          </p>
          <h2>Consent</h2>
          ...
          <h2>Log Files</h2>
          <p>https://id.strongnode.io follows a standard procedure of using log files. These files log visitors when they
          ...
          <p>Like any other website, https://id.strongnode.io uses 'cookies'. These cookies are used to store information
          ...
          <p>For more general information on cookies, please read <a
            href='https://www.generateprivacypolicy.com/#cookies'
                                                                  >the Cookies article on Generate Privacy Policy
            website
          </a>.
          </p>
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on https://id.strongnode.io, which are sent
          ...
          <p>Note that https://id.strongnode.io has no access to or control over these cookies that are used by
            third-party advertisers.
          </p>
          <h2>Third Party Privacy Policies</h2>
          <p>https://id.strongnode.io's Privacy Policy does not apply to other advertisers or websites. Thus, we are
          ...
          <p>https://id.strongnode.io does not knowingly collect any Personal Identifiable Information from children under
