    ...
    <>
      <Box>
        <div className="col-md-12">
          ...
          <p>
            At https://id.strongnode.io, accessible from
            https://id.strongnode.io, one of our main priorities is the privacy
            of our visitors. This Privacy Policy document contains types of
            information that is collected and recorded by
            https://id.strongnode.io and how we use it.
          </p>
          <p>
          ...
          <p>
            ...
            that they shared and/or collect in https://id.strongnode.io. This
          ...
          <h2>Log Files</h2>
          <p>
            https://id.strongnode.io follows a standard procedure of using log
          ...
          <p>
            Like any other website, https://id.strongnode.io uses 'cookies'.
          ...
          <p>
            ...
            advertising partners of https://id.strongnode.io.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on
            https://id.strongnode.io, which are sent directly to users' browser.
          ...
          <p>
            Note that https://id.strongnode.io has no access to or control over
            these cookies that are used by third-party advertisers.
          </p>
          <h2>Third Party Privacy Policies</h2>
          <p>
            https://id.strongnode.io's Privacy Policy does not apply to other
          ...
          <p>
            https://id.strongnode.io does not knowingly collect any Personal
