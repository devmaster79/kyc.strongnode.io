    ...
    <>
      <Box>
        <div className="col-md-12">
          ...
          <p>
            At https://id.strongnode.io, accessible from https://id.strongnode.io, one of our main
            priorities is the privacy of our visitors. This Privacy Policy document contains types
            of information that is collected and recorded by https://id.strongnode.io and how we use
            it.
          </p>
          <p>
          ...
          <p>
            ...
            https://id.strongnode.io. This policy is not applicable to any information collected
          ...
          <h2>Log Files</h2>
          <p>
            https://id.strongnode.io follows a standard procedure of using log files. These files
          ...
          <p>
            Like any other website, https://id.strongnode.io uses 'cookies'. These cookies are used
          ...
          <p>
            ...
            partners of https://id.strongnode.io.
          </p>
          <p>
            ...
            https://id.strongnode.io, which are sent directly to users' browser. They automatically
          ...
          <p>
            Note that https://id.strongnode.io has no access to or control over these cookies that
            are used by third-party advertisers.
          </p>
          <h2>Third Party Privacy Policies</h2>
          <p>
            https://id.strongnode.io's Privacy Policy does not apply to other advertisers or
          ...
          <p>
            https://id.strongnode.io does not knowingly collect any Personal Identifiable
