...
const authServices = {
  sendSMSAndSaveNumber: sendSMSAndSaveNumber,
...
const Msgs = (props: { authService: ServicesProps<typeof authServices> }) => {
  if (props.authService.last === "sendSMSAndSaveNumber")
    return <SendSMSAndSaveNumberMsg data={props.authService.data} />;
  if (props.authService.last === "verifyOTPAndEnableSMSAuth")
    return <VerifyOTPAndEnableSMSAuthMsg data={props.authService.data} />;
  return (
...
const SendSMSAndSaveNumberMsg = (
  ...
  if (props.data.result == "success")
    return <Info>We have sent you an SMS with the password.</Info>;
  ...
  if (props.data.result == "validation-error")
    return <Error>Wrong phone number.</Error>;
