...
/**
 * Page that allows user to contact user support.
 * @returns {JSX.Element}
 * @constructor
 */
        ...
        <Container>
            <CardStyle>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <textarea placeholder={'Message'} {...register("message", { required: true })} style={textAreaStyle} />
                    {/* errors will return when field validation fails  */}
                    {errors.message && <span>This field is required</span>}

                    <Button variant="contained" type="submit" sx={{ width: '20%', marginTop: '24px', cursor: 'pointer' }}>
                        {buttonTitle}
                    </Button>
                </form>
            </CardStyle>
