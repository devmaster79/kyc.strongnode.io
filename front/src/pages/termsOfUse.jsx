  ...
  return (
    <>
      <Box>
        ...
        <p>
          These terms and conditions outline the rules and regulations for the use of Strongnode's
          Website, located at https://id.strongnode.io.
        </p>

        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue
          to use id.strongnode.io if you do not agree to take all of the terms and conditions stated
          on this page.
        </p>
        ...
        <p>
          We employ the use of cookies. By accessing id.strongnode.io, you agreed to use cookies in
          agreement with the Strongnode's Privacy Policy.{' '}
        </p>
        ...
        <p>
          Unless otherwise stated, Strongnode and/or its licensors own the intellectual property
          rights for all material on id.strongnode.io. All intellectual property rights are
          reserved. You may access this from id.strongnode.io for your own personal use subjected to
        ...
        <p>
          ...
          information in certain areas of the website. Strongnode does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do not reflect the views
          and opinions of Strongnode,its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Strongnode shall not be liable for the Comments or for any liability,
          damages or expenses caused and/or suffered as a result of any use of and/or posting of
          and/or appearance of the Comments on this website.
        </p>

        <p>
          Strongnode reserves the right to monitor all Comments and to remove any Comments which can
        ...
        <p>
          You hereby grant Strongnode a non-exclusive license to use, reproduce, edit and authorize
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of Strongnode; and (d) the link is in
        ...
        <p>
          ...
          linking to our website, you must inform us by sending an e-mail to Strongnode. Please
        ...
        <p>
          No use of Strongnode's logo or other artwork will be allowed for linking absent a
