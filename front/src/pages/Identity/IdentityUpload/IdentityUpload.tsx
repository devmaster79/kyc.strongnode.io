...
export default function IdentityUpload (props: UploadProps) {
  ...
  return (
    <UploadWrapper>
      ...
      { image ? <img src={image || ''} /> :   <Icon name={props.icon} width={354} height={196} viewBox="0 0 354 196" />
      }
      <Button color='white' variant='medium' onClick={onUploadButtonClick}>{ image ? 'Upload new picture' : 'Upload picture'}</Button>
