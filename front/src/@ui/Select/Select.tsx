    ...
    <SelectWrapper>
      <HeaderWrapper onClick={() => setOpened(!opened)}>
        ...
        <Icon
          ...
          height={6}
          viewBox='0 0 8 6'
          style={opened ? { transform: 'rotate(180deg)', transition: '450ms ease' } : { transition: '450ms ease' }}
          ...
          <ul>
            {props.options.map((option) =>
              <li
                ...
                className={props.value && option[props.trackBy] === props.value[props.trackBy] ? 'active' : ''}
