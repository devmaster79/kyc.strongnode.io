...
type AuthByAuthenticatorResponse = Success & { token: string }
  | UnexpectedError
  | UnauthorizedError
  | BannedError
...
type GenerateAuthenticatorQRCodeResponse = { result: 'success', qrcode: string }
  | UnauthorizedError
  | UnexpectedError
...
type EnableAuthenticatorAuthResponse = GenericResponse
  | ValidationError<'token', undefined>
  | ValidationError<'token', 'wrong'>
