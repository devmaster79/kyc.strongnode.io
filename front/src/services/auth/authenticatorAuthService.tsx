...
export async function authByAuthenticator(otp: string) {
  const data = await getResponseData<AuthByAuthenticatorRequest, AuthByAuthenticatorResponse>(
    urls.authByAuthenticator,
    { token: otp }
  );
...
export async function enableAuthenticatorAuth(token: string) {
  return await getResponseData<EnableAuthenticatorAuthRequest, EnableAuthenticatorAuthResponse>(
    urls.enableAuthenticatorAuth,
    { token }
  );
}
...
export async function disableAuthenticatorAuth() {
  return await getResponseData<DisableAuthenticatorAuthRequest, DisableAuthenticatorAuthResponse>(
