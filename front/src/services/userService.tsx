...
export function getProfile (): Promise<AxiosResponse<GetProfileResult, unknown>> {
...
export function getInvestorDetails (): Promise<AxiosResponse<GetInvestorDetailsResult, unknown>> {
...
export function uploadProfileImage (email: string, username: string, image: string) {
